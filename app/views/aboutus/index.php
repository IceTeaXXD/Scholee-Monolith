...
<div class="container flow-content">
    ...
    <ul role="list" class="grid">
        <li>
            <article class="card" data-visible="false">
                <div class="card__front flow-content">
                    <img class="card__img mx-auto" src="https://media.licdn.com/dms/image/C5603AQGPYTUXPvg4iQ/profile-displayphoto-shrink_800_800/0/1629891955062?e=1701907200&v=beta&t=XBX3bDcnHD5A-7hrkbHH-B2SyNWiyCCa-Ac1qZ21xLM" alt="Portrait of Henry Anand Septian R." />
                    <div class="flow-content" data-spacing="sm">
                        <p class="card__name">Henry Anand Septian R.</p>
                        <p class="card__position">13521004</p>
                    </div>
                </div>
                ...
                <footer class="card__footer">
                    <button data-card-controller class="card__toggle" aria-label="Toggle card details for Henry Anand Septian R.">
        ...
        <li>
            <article class="card" data-visible="false">
                <div class="card__front flow-content">
                    <img class="card__img mx-auto" src="https://media.licdn.com/dms/image/C4D03AQG6Iacmk5bpAQ/profile-displayphoto-shrink_200_200/0/1632934624732?e=1701907200&v=beta&t=GiOJUZhaTMQ2zjHbp4iZ_pZo7j5plmbWfkbV2lzs35M" alt="Portrait of Matthew Mahendra" />
                    <div class="flow-content" data-spacing="sm">
                        <p class="card__name">Matthew Mahendra</p>
                        <p class="card__position">13521007</p>
                    </div>
                </div>
                <div class="card__back flow-content">
                    <p class="card__name">Matthew Mahendra</p>
                ...
                <footer class="card__footer">
                    <button data-card-controller class="card__toggle" aria-label="Toggle card details for Matthew Mahendra">
                        <i class="fa-solid fa-plus card__toggle-icon"></i>
                    </button>
                </footer>
            </article>
        ...
        <li>
            <article class="card" data-visible="false">
                <div class="card__front flow-content">
                    <img class="card__img mx-auto" src="https://avatars.githubusercontent.com/u/88835532?v=4" alt="Portrait of Ahmad Nadil" />
                    <div class="flow-content" data-spacing="sm">
                        <p class="card__name">Ahmad Nadil</p>
                        <p class="card__position">13521024</p>
                    </div>
                </div>
                <div class="card__back flow-content">
                    <p class="card__name">Ahmad Nadil</p>
                ...
                <footer class="card__footer">
                    <button data-card-controller class="card__toggle" aria-label="Toggle card details for Ahmad Nadil">
                        <i class="fa-solid fa-plus card__toggle-icon"></i>
                    </button>
                </footer>
            </article>
